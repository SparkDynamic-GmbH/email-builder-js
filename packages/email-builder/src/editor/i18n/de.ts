...
const de: TTranslations = {
  ...
  'fontFamily.MODERN_SANS': 'Moderne Serifenlose',
  'fontFamily.BOOK_SANS': 'Serifenlose Buchschrift',
  'fontFamily.ORGANIC_SANS': 'Organische Serifenlose',
  'fontFamily.GEOMETRIC_SANS': 'Geometrische Serifenlose',
  'fontFamily.HEAVY_SANS': 'Kräftige Serifenlose',
  'fontFamily.ROUNDED_SANS': 'Abgerundete Serifenlose',
  'fontFamily.MODERN_SERIF': 'Moderne Serifenschrift',
  'fontFamily.BOOK_SERIF': 'Serifen-Buchschrift',
  'fontFamily.MONOSPACE': 'Dicktengleich',
