...
const en = {
  ...
  'fontFamily.MODERN_SANS': 'Modern sans',
  'fontFamily.BOOK_SANS': 'Book sans',
  'fontFamily.ORGANIC_SANS': 'Organic sans',
  'fontFamily.GEOMETRIC_SANS': 'Geometric sans',
  'fontFamily.HEAVY_SANS': 'Heavy sans',
  'fontFamily.ROUNDED_SANS': 'Rounded sans',
  'fontFamily.MODERN_SERIF': 'Modern serif',
  'fontFamily.BOOK_SERIF': 'Book serif',
