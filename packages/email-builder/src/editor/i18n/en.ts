...
const en = {
  ...
  'option.imagePosition.top': 'Top',
  'option.imagePosition.left': 'Left',
  'option.imagePosition.right': 'Right',
  ...
  'richText.linkColor': 'Link color',
  'richText.linkColorDefault': 'Default',
  'richText.linkUnderline': 'Underline the link',
