...
| Style presets, block defaults | `src/editor/styleDefaults/` — the contract in `types.ts`, the shipped set in `presets.ts`. Adding a themable field means nothing here: the panels are the blocks' own                                                                                                                  |
